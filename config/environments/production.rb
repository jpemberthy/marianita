Marianita::Application.configure do
  ...
  config.action_mailer.default_url_options = { :host => "marianita.herokuapp.com" }
  config.action_mailer.delivery_method = :smtp
  config.action_mailer.smtp_settings = {
    :address              => "smtp.gmail.com",
    :port                 => 587,
    :domain               => 'bolsaenred.com',
    :user_name            => 'info@bolsaenred.com',
